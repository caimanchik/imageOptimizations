...
#pragma warning disable CA1416
    ...
    public unsafe void Write(double[,] yCh, double[,] cb, double[,] cr, int j, int i, int countY, int countX)
    {
        var ptr = (byte*)data.Scan0;
        ...
        for (var y = 0; y < countY; y++)
        {
            ...
            {
                *pos = ToByte((298.082 * yCh[y, x] + 516.412 * cb[y, x]) / 256.0 - 276.836);
                *(pos + 1) = ToByte((298.082 * yCh[y, x] - 100.291 * cb[y, x] - 208.120 * cr[y, x]) / 256.0 + 135.576);
                *(pos + 2) = ToByte((298.082 * yCh[y, x] + 408.583 * cr[y, x]) / 256.0 - 222.921);
            }
        }
    }
